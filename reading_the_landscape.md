---
title: Reading the Landscape of Davao City's Chinatown
---
...
<div align="center">
    ...
    <img src="assets/archways/arch_unity.jpg" alt="unity arch" width="65%">
    </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; margin: 1rem 0;">
  <img src="assets/archways/arch_unity_carp.jpg" alt="carp motif" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
  <img src="assets/archways/arch_unity_center.jpg" alt="center pattern" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
  <img src="assets/archways/arch_unity_dragons.jpg" alt="dragons" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
</div>
...
<div align="center">
<img src="assets/archways/unity_park.jpg" alt="unity park" width="55%">
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px; margin-bottom: 10px;">
    <img src="assets/archways/unity_park_sign.jpg" alt="unity park sign" style="width: 100%; height: 180px; object-fit: cover; border-radius: 4px;">
    <img src="assets/archways/unity_park_light.jpg" alt="unity arch streetlight" style="width: 100%; height: 180px; object-fit: cover; border-radius: 4px;">
...
<div align="center">
    <div style="margin-top: 15px; margin-bottom: 15px;">
    <img src="assets/archways/arch_peace.jpg" alt="peace arch" width="65%">
    </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 10px; margin-bottom: 10px;">
    <img src="assets/archways/arch_peace_plaque1.jpg" alt="peace archway plaque: welcome to chinatwon" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
    <img src="assets/archways/arch_peace_plaque2.jpg" alt="peace archway plauqe: yuchengco" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px; margin-bottom: 10px;">
    ...
    <img src="assets/street_signs/sta_ana_old.jpg" alt="Sta. Ana Old" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
    <img src="assets/street_signs/sta_ana_suyhoo.jpg" alt="Sta. Ana Suyhoo" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px;">
</div>
...
<div align="center">
    <div style="margin-top: 15px; margin-bottom: 15px;">
    <img src="assets/street_signs/ss_nodesign_alvarez.jpg" alt="Alvarez St. Sign no design" width="65%">
    </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 10px; margin-bottom: 10px;">
    ...
    <img src="assets/signage/sign_namao_2.jpg" alt="" style="width: 100%; height: 230px; object-fit: cover; border-radius: 4px;">        
